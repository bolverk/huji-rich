...
public:
  ...
  /*! \brief Calculates the pressure
    ...
    \return Presusre
   */
  virtual double de2p(double d, double e) const = 0;
  ...
  */
  virtual double de2c(double d, double e) const = 0;
  ...
  /*! \brief Calculates the speed of sound
    ...
    \return Speed of sound
   */
  virtual double dp2c(double d, double p) const = 0;
  ...
  /*! \brief Calculates the entropy per unit mass
    ...
    \return Entropy
  */
  virtual double dp2s(double d, double p) const = 0;
  /*! \brief Calculates the pressure from the netropy
    \param s Entropy
    \param d Density
    \return Entropy
  */
  virtual double sd2p(double s, double d) const = 0;
