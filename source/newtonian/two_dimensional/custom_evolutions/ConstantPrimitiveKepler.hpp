...
#ifndef COSNTANTPRIMITIVEKEPLER_HPP
#define COSNTANTPRIMITIVEKEPLER_HPP 1
...
*/
class ConstantPrimitiveKepler : public CustomEvolution
{
public:
	/*!
...
#endif //COSNTANTPRIMITIVEKEPLER_HPP
