...
namespace
{
	...
	/*vector<size_t> GetLastDuplicateList(vector<vector<size_t> > const& sorted_to_duplicate)
	{
	vector<size_t> res;
	for (size_t i = 0; i < sorted_to_duplicate.size(); ++i)
	res.insert(res.end(), sorted_to_duplicate[i].begin(), sorted_to_duplicate[i].end());
