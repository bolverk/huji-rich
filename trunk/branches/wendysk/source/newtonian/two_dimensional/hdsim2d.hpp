...
private:
  ...
  ScalarInterpolation *tracer_interp_;
...
public:
	...
	*/
	...
	//! \brief The vector of the CellsEvolve custom evolution
  vector<CustomEvolution*> CellsEvolve;
  ...
  */
  ...
  /*!
  \brief Sets the tracer's spatial interpolation
  \param tracer_interp The tracer interpolation
  */
  void setTracerInterpolation(ScalarInterpolation* tracer_interp);
  ...
  */
  ...
  /*! \brief Resets the primitive variables based on a tracer threshold
	...
	\param InnerNumber The number of cells to always reset
  */
  void TracerReset(double alpha,SpatialDistribution const& originalD,
	  ...
	  SpatialDistribution const& originalVy,int tracerindex,int InnerNumber=0);
