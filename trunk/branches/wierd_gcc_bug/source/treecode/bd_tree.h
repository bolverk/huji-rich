...
public:
	...
	virtual void getAc(ANNorthRect &bnd_box,vector<double> const& qpoint,
		double openangle,std::vector<double> &res,int dim){return;}
	virtual void getPot(vector<double> const& qpoint,
		double openangle,double soft,double &res){return;}
	virtual void SetH(vector<double> const&H){return;}
	virtual void SetMass(std::vector<double> const& masses,int dim){return;}
	virtual void SetVmax(std::vector<double> const& v){return;}
	virtual void SetCmax(std::vector<double> const& c){return;}
	virtual double GetMass(void)const{return 0;}
	virtual double GetVmax(void)const{return 0;}
	virtual double GetCmax(void)const{return 0;}
	...
	virtual double GetTimeStep(int index,std::vector<vector<double> >
		...
		vector<double> const& c,double dt,double v_i)const{return 0;}
};
