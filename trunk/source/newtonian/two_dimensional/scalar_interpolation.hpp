/*! \file scalar_interpolation.hpp
  \brief Abstract class for tracer interpolation
  \author Elad Steinberg
  \deprecated Due to unification of hydro and tracer interpolation
 */
...
//! \brief Scalar interpolation type
